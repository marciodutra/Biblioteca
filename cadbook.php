...
<div class="mdl-layout mdl-js-layout">
  ...
  <div class="mdl-layout__drawer">
    ...
    <form class="mui-form" action="recebe_book.php" method="post">
        <h1>Cadastrar novo livro:</h1>
            <div class="mui-textfield"><i class="material-icons">import_contacts</i>
             <input type="text" placeholder="Nome do livro" name="nome" required>
            </div>
            <br>
            <div class="mui-textfield"><i class="material-icons">bookmark_border</i>
           <input type="text" placeholder="Nome da editora" name="editora" required>
     </div>
       <br>
