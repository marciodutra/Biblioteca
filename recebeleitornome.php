...
<div class="mdl-layout mdl-js-layout">
  ...
  include "config.php";
  include "antisql.php";
  $user = antisql($conexao,$_POST["nomeleitor"]);
  $sql = "SELECT *FROM leitor WHERE nome LIKE '%$user%'";
  $sqlExecuta = mysqli_query($conexao,$sql);
  ...
  <tbody>
    ...
    ?>
    <td><i class="material-icons">sentiment_very_dissatisfied</i>&nbsp;Leitor(a) não encontrado</td>
    <?php
}
?>
  </tbody>
