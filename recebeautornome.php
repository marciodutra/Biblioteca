...
<div class="mdl-layout mdl-js-layout">
  ...
  include "config.php";
  include "antisql.php";
  $autor = antisql($conexao,$_POST["nomeautor"]);
  $sql = "SELECT *FROM livro WHERE autor LIKE '%$autor%'";
  $sqlExecuta = mysqli_query($conexao,$sql);
  ...
  <tbody>
    ...
    ?>
    <td><i class="material-icons">sentiment_very_dissatisfied</i>&nbsp;Autor não encontrado</td>
    <?php
}
?>
  </tbody>
