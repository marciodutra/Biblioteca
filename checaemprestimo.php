...
<div class="mdl-layout mdl-js-layout">
  ...
  <main class="mdl-layout__content">
    ...
    <h1>Checar livros em locação:</h1>
    <form action="consemprestimo.php" method="POST">
    <div class="mui-textfield">
  <input type="text" placeholder="Digite uma data EX: 2017/09/02" name="emprestimo" required></br>
